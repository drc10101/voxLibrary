...
<div id="plan-bar" style="display:none; background:#1a1a2e; padding:10px 40px; border-bottom:1px solid #333; flex-wrap:wrap; gap:15px; align-items:center;">
  <div style="display:flex; gap:10px; align-items:center;">
    ...
    <button onclick="upgradePlan('starter')" style="background:#333; border:none; color:#aaa; padding:6px 12px; border-radius:6px; font-size:12px; cursor:pointer;">$9.99/mo</button>
    <button onclick="upgradePlan('creator')" style="background:#333; border:none; color:#aaa; padding:6px 12px; border-radius:6px; font-size:12px; cursor:pointer;">$24.99/mo</button>
    <button onclick="upgradePlan('studio')" style="background:#333; border:none; color:#aaa; padding:6px 12px; border-radius:6px; font-size:12px; cursor:pointer;">$59.99/mo</button>
    <button onclick="upgradePlan('pro')" style="background:#667eea; border:none; color:#fff; padding:6px 12px; border-radius:6px; font-size:12px; cursor:pointer; font-weight:bold;">$129.99/mo</button>
  </div>

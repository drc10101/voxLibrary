...
upload_start = content.find(b'  // API: Upload voice (Bring Your Own Voice)')
static_start = content.find(b'  // Serve static files')
print('Upload at:', upload_start, 'Static at:', static_start)

# Extract and verify
snippet = content[upload_start:static_start]
print('Snippet preview:')
print(repr(snippet[:200]))
print('...')
print(repr(snippet[-100:]))

new_block = b'''  // API: Upload voice (Bring Your Own Voice)
...
new_content = content[:upload_start] + new_block + content[static_start:]
